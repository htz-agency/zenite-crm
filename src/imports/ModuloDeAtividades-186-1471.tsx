...
import svgPaths from "./svg-kqh22as0o6";
...
import { imgAtividades } from "./svg-camvb";
  ...
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0">
      ...
      <div className="col-1 h-[29px] ml-[6px] mt-[22px] relative row-1 w-[114px]">
        <BackgroundImageAndText7 text="Sim" additionalClassNames="left-[3px] top-[26px] w-[83px]" />
      </div>
...
function BackgroundImage4({ text, text1 }: BackgroundImage4Props) {
  return (
    <div className="col-1 h-[41px] ml-[6px] mt-[16px] relative row-1 w-[114px]">
      <BackgroundImageAndText7 text={text} additionalClassNames="left-[3px] top-[26px] w-[83px]" />
      <div className="absolute content-stretch flex h-[12px] items-center left-0 top-[26px] w-[106px]">
...
function BackgroundImage2({ additionalClassNames = "" }: BackgroundImage2Props) {
  return (
    <div className="content-stretch flex gap-[10px] items-center relative shrink-0">
      <BackgroundImageAndText4 text="􀆊" additionalClassNames="shrink-0" />
      ...
      <div className="overflow-clip relative rounded-[500px] shrink-0 size-[28px]" data-name="Button - Symbol">
        <BackgroundImageAndText3 text="􀍀" additionalClassNames="text-[#28415c]" />
      </div>
    </div>
  );
}
...
function ActivityBackgroundImage4({ text, text1, additionalClassNames = "" }: ActivityBackgroundImage4Props) {
  return (
    <BackgroundImage6>
      <ButtonSymbolBackgroundImageAndText1 text="􀆊" additionalClassNames="rounded-[500px]" />
      <ButtonSymbolBackgroundImageAndText1 text="􀍕" additionalClassNames="bg-[#dde3ec] rounded-[8px]" />
  ...
  return (
    <BackgroundImage6>
      ...
      <div className="bg-[#dcf0ff] overflow-clip relative rounded-[8px] shrink-0 size-[28px]" data-name="Button - Symbol">
        <BackgroundImageAndText3 text="􀌤" additionalClassNames="text-[#07abde]" />
      </div>
      <p className="font-['DM_Sans:Medium',sans-serif] leading-[22px] not-italic relative shrink-0 text-[#4e6987] text-[15px] tracking-[-0.5px] w-[110px] whitespace-pre-wrap" style={{ fontFeatureSettings: "'ss01', 'ss04', 'ss05', 'ss07'" }}>
        {text}
      </p>
  ...
  return (
    <BackgroundImage6>
      ...
      <div className="bg-[#feedca] overflow-clip relative rounded-[8px] shrink-0 size-[28px]" data-name="Button - Symbol">
        <BackgroundImageAndText3 text="􀻡" additionalClassNames="text-[#eac23d]" />
      </div>
      <p className="font-['DM_Sans:Medium',sans-serif] leading-[22px] not-italic relative shrink-0 text-[#4e6987] text-[15px] tracking-[-0.5px] w-[110px] whitespace-pre-wrap" style={{ fontFeatureSettings: "'ss01', 'ss04', 'ss05', 'ss07'" }}>
        {text}
      </p>
  ...
  return (
    <BackgroundImage6>
      ...
      <div className="bg-[#d9f8ef] overflow-clip relative rounded-[8px] shrink-0 size-[28px]" data-name="Button - Symbol">
        <BackgroundImageAndText3 text="􀌾" additionalClassNames="text-[#3ccea7]" />
      </div>
      <p className="font-['DM_Sans:Medium',sans-serif] leading-[22px] not-italic relative shrink-0 text-[#4e6987] text-[15px] tracking-[-0.5px] w-[110px] whitespace-pre-wrap" style={{ fontFeatureSettings: "'ss01', 'ss04', 'ss05', 'ss07'" }}>
        {text}
      </p>
  ...
  return (
    <BackgroundImage6>
      ...
      <div className="bg-[#e8e8fd] overflow-clip relative rounded-[8px] shrink-0 size-[28px]" data-name="Button - Symbol">
        <BackgroundImageAndText3 text="􀁢" additionalClassNames="text-[#8c8cd4]" />
      </div>
      <p className="font-['DM_Sans:Medium',sans-serif] leading-[22px] not-italic relative shrink-0 text-[#4e6987] text-[15px] tracking-[-0.5px] w-[110px] whitespace-pre-wrap" style={{ fontFeatureSettings: "'ss01', 'ss04', 'ss05', 'ss07'" }}>
        {text}
      </p>
...
function BackgroundImageAndText4({ text, additionalClassNames = "" }: BackgroundImageAndText4Props) {
  return <BackgroundImageAndText5 text={text} additionalClassNames={clsx("flex flex-col font-['SF_Pro:Semibold',sans-serif] font-[590] justify-center leading-[0] relative size-[13px] text-[#4e6987] text-[12px] text-center", additionalClassNames)} />;
}
...
function BackgroundImageAndText3({ text, additionalClassNames = "" }: BackgroundImageAndText3Props) {
  return <BackgroundImageAndText5 text={text} additionalClassNames={clsx("-translate-x-1/2 -translate-y-1/2 absolute flex flex-col font-['SF_Pro:Semibold',sans-serif] font-[590] justify-center leading-[0] left-1/2 size-[28px] text-[17px] text-center top-1/2", additionalClassNames)} />;
}
type ButtonSymbolBackgroundImageAndText1Props = {
  text: string;
  additionalClassNames?: string;
};

function ButtonSymbolBackgroundImageAndText1({ text, additionalClassNames = "" }: ButtonSymbolBackgroundImageAndText1Props) {
  return (
    <div className={clsx("overflow-clip relative shrink-0 size-[28px]", additionalClassNames)}>
      <BackgroundImageAndText3 text={text} additionalClassNames="text-[#4e6987]" />
    </div>
  );
}
type ModuloDeAtividadesActivityBackgroundImageProps = {
  text: string;
  text1: string;
  text2: string;
  text3: string;
...
function ModuloDeAtividadesActivityBackgroundImage({ text, text1, text2, text3 }: ModuloDeAtividadesActivityBackgroundImageProps) {
  return (
    <BackgroundImage6>
      <ButtonSymbolBackgroundImageAndText1 text={text} additionalClassNames="rounded-[500px]" />
      <div className="bg-[#ffedeb] overflow-clip relative rounded-[8px] shrink-0 size-[28px]" data-name="Button - Symbol">
        <BackgroundImageAndText3 text={text1} additionalClassNames="text-[#ff8c76]" />
      </div>
      <p className="font-['DM_Sans:Medium',sans-serif] leading-[22px] not-italic relative shrink-0 text-[#4e6987] text-[15px] tracking-[-0.5px] w-[110px] whitespace-pre-wrap" style={{ fontFeatureSettings: "'ss01', 'ss04', 'ss05', 'ss07'" }}>
        {text2}
      </p>
...
function ButtonSymbolBackgroundImage({ additionalClassNames = "" }: ButtonSymbolBackgroundImageProps) {
  return (
    <div style={{ backgroundImage: "url('data:image/svg+xml;utf8,<svg viewBox=\\'0 0 28 28\\' xmlns=\\'http://www.w3.org/2000/svg\\' preserveAspectRatio=\\'none\\'><rect x=\\'0\\' y=\\'0\\' height=\\'100%\\' width=\\'100%\\' fill=\\'url(%23grad)\\' opacity=\\'0.20000000298023224\\'/><defs><radialGradient id=\\'grad\\' gradientUnits=\\'userSpaceOnUse\\' cx=\\'0\\' cy=\\'0\\' r=\\'10\\' gradientTransform=\\'matrix(-6.3973e-9 -2.2 2.2 -6.3973e-9 14 28)\\'><stop stop-color=\\'rgba(255,255,255,1)\\' offset=\\'0\\'/><stop stop-color=\\'rgba(255,255,255,0)\\' offset=\\'1\\'/></radialGradient></defs></svg>'), linear-gradient(90deg, rgb(7, 171, 222) 0%, rgb(7, 171, 222) 100%)" }} className="absolute left-[210px] overflow-clip rounded-[500px] size-[28px] top-[20px]">
      <BackgroundImageAndText2 text="􀊫" additionalClassNames="text-[#f6f7f9]" />
    </div>
  );
}
...
function BackgroundImageAndText({ text }: BackgroundImageAndTextProps) {
  return (
    <div className="absolute left-[258px] overflow-clip rounded-[500px] size-[28px] top-[20px]">
      <BackgroundImageAndText2 text={text} additionalClassNames="text-[#28415c]" />
    </div>
  );
}
    ...
    <div className={className || "h-[652px] relative w-[306px]"}>
        ...
        <>
                  ...
                  <>
                    <div className="content-stretch flex items-center p-[6px] relative rounded-[8px] shrink-0 w-[170px]">
                      <div className={`overflow-clip relative rounded-[8px] shrink-0 size-[28px] ${isVariant4OrVariant5 ? "bg-[#dcf0ff]" : "bg-[#d9f8ef]"}`} data-name="Button - Symbol">
                        <div className={`-translate-x-1/2 -translate-y-1/2 absolute flex flex-col font-["SF_Pro:Semibold",sans-serif] font-[590] justify-center leading-[0] left-1/2 size-[28px] text-center top-1/2 ${isVariant4OrVariant5 ? "text-[#28415c] text-[13px]" : "text-[#3ccea7] text-[17px]"}`} style={isVariant4OrVariant5 ? { fontVariationSettings: "'wdth' 100" } : { fontVariationSettings: "'wdth' 100", fontFeatureSettings: "'ss15'" }}>
                          <p className="leading-[22px] whitespace-pre-wrap">{isVariant4OrVariant5 ? "􀌤" : isVariant8 ? "􀌾" : ""}</p>
                        </div>
                      </div>
                      <div className="h-[20px] shrink-0 w-[6px]" />
                      <p className="font-['DM_Sans:Medium',sans-serif] leading-[22px] not-italic relative shrink-0 text-[#4e6987] text-[18px] tracking-[-0.5px]" style={{ fontFeatureSettings: "'ss01', 'ss04', 'ss05', 'ss07'" }}>
                      ...
                      <div className="overflow-clip relative rounded-[500px] shrink-0 size-[28px]" data-name="Button - Symbol">
                        <div className={`-translate-x-1/2 -translate-y-1/2 absolute flex flex-col font-["SF_Pro:Semibold",sans-serif] font-[590] justify-center leading-[0] left-1/2 size-[28px] text-center top-1/2 ${isVariant4OrVariant5 ? "text-[#28415c] text-[13px]" : "text-[#4e6987] text-[17px]"}`} style={isVariant4OrVariant5 ? { fontVariationSettings: "'wdth' 100" } : { fontVariationSettings: "'wdth' 100", fontFeatureSettings: "'ss15'" }}>
                          <p className="leading-[22px] whitespace-pre-wrap">􀆈</p>
                        </div>
                      </div>
                    </div>
                    <div className="overflow-clip relative rounded-[500px] shrink-0 size-[28px]" data-name="Button - Symbol">
                      <div className={`-translate-x-1/2 -translate-y-1/2 absolute flex flex-col font-["SF_Pro:Semibold",sans-serif] font-[590] justify-center leading-[0] left-1/2 size-[28px] text-[#28415c] text-center top-1/2 ${isVariant4OrVariant5 ? "text-[13px]" : "text-[17px]"}`} style={isVariant4OrVariant5 ? { fontVariationSettings: "'wdth' 100" } : { fontVariationSettings: "'wdth' 100", fontFeatureSettings: "'ss15'" }}>
          ...
          <div className={`absolute ${isVariant5 ? "contents inset-[26.99%_6.54%_1.84%_6.54%]" : isVariant4OrVariant6 ? "contents inset-[10.74%_6.21%_18.1%_6.86%]" : "content-stretch flex inset-[2.15%_37.91%_91.72%_6.54%] items-center p-[6px] rounded-[8px]"}`}>
            ...
            <div className={`overflow-clip size-[28px] ${isVariant5 ? "absolute bg-[#f6f7f9] left-[243px] rounded-[500px] top-[526px]" : isVariant4OrVariant6 ? "absolute bg-[#f6f7f9] left-[244px] rounded-[500px] top-[420px]" : "bg-[#d9f8ef] relative rounded-[8px] shrink-0"}`} data-name="Button - Symbol">
              <div className="-translate-x-1/2 -translate-y-1/2 absolute flex flex-col font-['SF_Pro:Semibold',sans-serif] font-[590] justify-center leading-[0] left-1/2 size-[28px] text-[#28415c] text-[13px] text-center top-1/2" style={{ fontVariationSettings: "'wdth' 100" }}>
      ...
      {isDefault && (
        <>
          <div className="absolute content-stretch flex flex-col gap-[4px] inset-[19.33%_0.49%_12.27%_0.49%] items-center" data-name="Atividades">
            ...
            <ModuloDeAtividadesActivityBackgroundImage text="􀆊" text1="􀉉" text2="Compromisso" text3="04/01/2024 09:30" />
            <p className="font-['DM_Sans:Bold',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#64676c] text-[10px] text-center tracking-[0.5px] uppercase w-[102px] whitespace-pre-wrap" style={{ fontFeatureSettings: "'ss01', 'ss04', 'ss05', 'ss07'" }}>
              Julho
            </p>
            <ActivityBackgroundImage text="Tarefa" text1="04/01/2024 09:30" />
            <ActivityBackgroundImage1 text="Ligação" text1="04/01/2024 09:30" />
            <ActivityBackgroundImage2 text="Nota" text1="04/01/2024 09:30" />
            <p className="font-['DM_Sans:Bold',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#64676c] text-[10px] text-center tracking-[0.5px] uppercase w-[102px] whitespace-pre-wrap" style={{ fontFeatureSettings: "'ss01', 'ss04', 'ss05', 'ss07'" }}>
              Junho
            </p>
            <ActivityBackgroundImage3 text="Mensagem" text1="04/01/2024 09:30" />
            <p className="font-['DM_Sans:Bold',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#64676c] text-[10px] text-center tracking-[0.5px] uppercase w-[102px] whitespace-pre-wrap" style={{ fontFeatureSettings: "'ss01', 'ss04', 'ss05', 'ss07'" }}>
              2022
            </p>
            <ActivityBackgroundImage4 text="Email" text1="04/01/2024 09:30" />
          </div>
        ...
        <>
          <BackgroundImage7>
            <div className="content-stretch flex items-center p-[6px] relative rounded-[8px] shrink-0 w-[170px]">
              ...
              <ButtonSymbolBackgroundImageAndText1 text="􀆈" additionalClassNames="rounded-[500px]" />
            </div>
          ...
          <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
            <div className="col-1 content-stretch flex gap-[10px] items-center ml-0 mt-0 relative row-1">
              <div className="flex items-center justify-center relative shrink-0 size-[13px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "19" } as React.CSSProperties}>
                <div className="flex-none rotate-90">
                  <BackgroundImageAndText4 text="􀆊" />
                </div>
              </div>
              <BackgroundImage1 text="+55 98899-8899" text1="04/07/2023 09:30" />
            ...
            <div className="col-1 grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-[41px] mt-[42.99px] place-items-start relative row-1">
              ...
              <div className="col-1 ml-[13.5px] mt-[58.01px] overflow-clip relative rounded-[500px] row-1 size-[28px]" data-name="Button - Symbol">
                <BackgroundImageAndText3 text="􀌄" additionalClassNames="text-[#98989d]" />
              </div>
              <div className="col-1 ml-[13.5px] mt-[23.01px] overflow-clip relative rounded-[500px] row-1 size-[28px]" data-name="Button - Symbol">
                <BackgroundImageAndText3 text="􀍀" additionalClassNames="text-[#98989d]" />
              </div>
            </div>
          </div>
          <BackgroundImage2 />
      ...
      {isVariant8 && (
        <>
          <div className="absolute bg-[#f6f7f9] inset-[34.97%_64.05%_57.06%_18.95%] overflow-clip rounded-[500px]" data-name="Button - Symbol">
            <BackgroundImageAndText1 text="1" />
          </div>
          ...
          <div className="absolute backdrop-blur-[50px] bg-[#3ccea7] inset-[79.14%_41.83%_12.88%_41.18%] rounded-[500px]" data-name="Button - Symbol">
            <div className="overflow-clip relative rounded-[inherit] size-full">
              <BackgroundImageAndText1 text="􀌿" />
            </div>
          ...
          <div className="absolute bg-[#f6f7f9] inset-[46.01%_19.61%_46.01%_63.4%] overflow-clip rounded-[500px]" data-name="Button - Symbol">
            <BackgroundImageAndText1 text="6" />
          </div>
      ...
      {isVariant3 && (
        <>
          ...
          <BackgroundImage7>
            <div className="content-stretch flex items-center p-[6px] relative rounded-[8px] shrink-0 w-[170px]">
              <ButtonSymbolBackgroundImageAndText1 text="􀣔" additionalClassNames="bg-[#dde3ec] rounded-[8px]" />
              <div className="h-[20px] shrink-0 w-[6px]" />
              <p className="font-['DM_Sans:Medium',sans-serif] leading-[22px] not-italic relative shrink-0 text-[#4e6987] text-[18px] tracking-[-0.5px]" style={{ fontFeatureSettings: "'ss01', 'ss04', 'ss05', 'ss07'" }}>
                Atividades
              </p>
            ...
            <div className="bg-[#07abde] overflow-clip relative rounded-[500px] shrink-0 size-[28px]" data-name="Button - Symbol">
              <BackgroundImageAndText3 text="􀜓" additionalClassNames="text-[#28415c]" />
            </div>
            <div className="overflow-clip relative rounded-[500px] shrink-0 size-[28px]" data-name="Button - Symbol">
              <BackgroundImageAndText3 text="􀆏" additionalClassNames="text-[#28415c]" />
            </div>
          </BackgroundImage7>
          <ModuloDeAtividadesButtonTextBackgroundImage>
        ...
        <>
          ...
          <div className="absolute content-stretch flex flex-col gap-[26px] inset-[19.33%_52.29%_13.19%_6.54%] items-center leading-[0]">
            <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0">
              ...
              <div className="col-1 content-stretch flex h-[10px] items-center ml-0 mt-0 relative row-1 w-[126px]">
                ...
                <BackgroundImageAndText6 text="ÚLTIMA ATIVIDADE" />
              </div>
            </div>
            <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0">
              <div className="bg-[#f6f7f9] col-1 h-[45px] ml-0 mt-[14px] rounded-[8px] row-1 w-[126px]" />
              ...
              <div className="col-1 content-stretch flex h-[10px] items-center ml-0 mt-0 relative row-1 w-[126px]">
                <ButtonSymbolBackgroundImageAndText text="􀆿" additionalClassNames="rounded-[100px] size-[16px]" />
                <BackgroundImageAndText6 text="emails trocados" />
              </div>
            </div>
            <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0">
              <div className="bg-[#f6f7f9] col-1 h-[45px] ml-0 mt-[14px] rounded-[8px] row-1 w-[126px]" />
              <div className="col-1 h-[29px] ml-[6px] mt-[22px] relative row-1 w-[114px]">
                <BackgroundImageAndText7 text="56% WhatsApp" additionalClassNames="left-[4px] top-[26px] w-[106px]" />
              </div>
              <div className="col-1 content-stretch flex h-[10px] items-center ml-0 mt-0 relative row-1 w-[126px]">
                <ButtonSymbolBackgroundImageAndText text="􀆿" additionalClassNames="rounded-[100px] size-[16px]" />
                <BackgroundImageAndText6 text="canal principal" />
              </div>
            </div>
            <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0">
              <div className="bg-[#f6f7f9] col-1 h-[45px] ml-0 mt-[14px] rounded-[8px] row-1 w-[126px]" />
              <div className="col-1 h-[41px] ml-[6px] mt-[16px] relative row-1 w-[114px]">
                <BackgroundImageAndText7 text="7,3 pontos" additionalClassNames="left-[3px] top-[25px] w-[111px]" />
                <BackgroundImage5 />
              </div>
              <div className="col-1 content-stretch flex h-[10px] items-center ml-0 mt-0 relative row-1 w-[126px]">
                <ButtonSymbolBackgroundImageAndText text="􀆿" additionalClassNames="rounded-[100px] size-[16px]" />
                <BackgroundImageAndText6 text="renitência" />
              </div>
            </div>
            <BackgroundImage13>
              <ButtonSymbolBackgroundImageAndText text="􀆿" additionalClassNames="rounded-[100px] size-[16px]" />
              <BackgroundImageAndText6 text="TAREFA FUTURA?" />
            </BackgroundImage13>
          </div>
          <div className="absolute content-stretch flex flex-col gap-[26px] inset-[19.33%_6.54%_13.19%_52.29%] items-center leading-[0]">
            <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0">
              <div className="bg-[#f6f7f9] col-1 h-[45px] ml-0 mt-[14px] rounded-[8px] row-1 w-[126px]" />
              <div className="col-1 h-[41px] ml-[6px] mt-[16px] relative row-1 w-[114px]">
                <BackgroundImageAndText7 text="31 atividades" additionalClassNames="left-[3px] top-[25px] w-[111px]" />
                <div className="absolute content-stretch flex h-[12px] items-center left-0 top-[26px] w-[106px]">
              ...
              <div className="col-1 content-stretch flex h-[10px] items-center ml-0 mt-0 relative row-1 w-[126px]">
                <ButtonSymbolBackgroundImageAndText text="􀆿" additionalClassNames="rounded-[100px] size-[16px]" />
                <BackgroundImageAndText6 text="ATIVIDADES TOTAIS" />
              </div>
            </div>
            <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0">
              <div className="bg-[#f6f7f9] col-1 h-[45px] ml-0 mt-[14px] rounded-[8px] row-1 w-[126px]" />
              <div className="col-1 h-[41px] ml-[6px] mt-[16px] relative row-1 w-[114px]">
                <BackgroundImageAndText7 text="7 ligações" additionalClassNames="left-[3px] top-[25px] w-[111px]" />
                <BackgroundImage5 />
              </div>
              <div className="col-1 content-stretch flex h-[10px] items-center ml-0 mt-0 relative row-1 w-[126px]">
                <ButtonSymbolBackgroundImageAndText text="􀆿" additionalClassNames="rounded-[100px] size-[16px]" />
                <BackgroundImageAndText6 text="total de ligações" />
              </div>
            </div>
            <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0">
              <div className="bg-[#f6f7f9] col-1 h-[45px] ml-0 mt-[14px] rounded-[8px] row-1 w-[126px]" />
              ...
              <div className="col-1 content-stretch flex h-[10px] items-center ml-0 mt-0 relative row-1 w-[126px]">
                <ButtonSymbolBackgroundImageAndText text="􀆿" additionalClassNames="rounded-[100px] size-[16px]" />
                <BackgroundImageAndText6 text="tempo de resposta" />
              </div>
            </div>
            <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0">
              <div className="bg-[#f6f7f9] col-1 h-[45px] ml-0 mt-[14px] rounded-[8px] row-1 w-[126px]" />
              ...
              <div className="col-1 content-stretch flex h-[10px] items-center ml-0 mt-0 relative row-1 w-[126px]">
                <ButtonSymbolBackgroundImageAndText text="􀆿" additionalClassNames="rounded-[100px] size-[16px]" />
                <BackgroundImageAndText6 text="total de reuniões" />
              </div>
            </div>
            <BackgroundImage13>
              <ButtonSymbolBackgroundImageAndText text="􀆿" additionalClassNames="rounded-[100px] size-[16px]" />
              <BackgroundImageAndText6 text="tem anotações" />
            </BackgroundImage13>
          </div>
          <BackgroundImage8>
...
export default function ModuloDeAtividades1() {
  return <ModuloDeAtividades className="relative size-full" property1="Variant7" />;
}