...
import svgPaths from "./svg-jxw3ihfgrt";
...
import { imgAtividades } from "./svg-k3e15";
  ...
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0">
      ...
      <div className="col-1 h-[29px] ml-[6px] mt-[22px] relative row-1 w-[114px]">
        <BackgroundImageAndText8 text="Sim" additionalClassNames="left-[3px] top-[26px] w-[83px]" />
      </div>
...
function ButtonBackgroundImage({ children }: React.PropsWithChildren<{}>) {
  return (
    <div className="backdrop-blur-[50px] bg-[#28415c] flex-[1_0_0] h-[36px] min-h-px min-w-px relative rounded-[20px]">
...
function BackgroundImage11({ children }: React.PropsWithChildren<{}>) {
  return (
    <div style={{ fontVariationSettings: "'wdth' 100" }} className="-translate-x-1/2 -translate-y-1/2 absolute flex flex-col font-['SF_Pro:Semibold',sans-serif] font-[590] justify-center leading-[0] left-1/2 size-[28px] text-[#28415c] text-[13px] text-center top-1/2">
...
function BackgroundImage8({ children, additionalClassNames = "" }: React.PropsWithChildren<BackgroundImage8Props>) {
  return (
    <div className={clsx("h-[36px] relative rounded-[100px]", additionalClassNames)}>
      <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">{children}</div>
    </div>
  );
}
...
function SegmentedControlBackgroundImage({ children }: React.PropsWithChildren<{}>) {
  return (
    <div className="absolute bg-[#f6f7f9] inset-[2.15%_4.9%_91.1%_4.9%] rounded-[100px]">
      <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[4px] items-center justify-center p-[4px] relative size-full">{children}</div>
      </div>
...
function BackgroundImageAndText8({ text, additionalClassNames = "" }: BackgroundImageAndText8Props) {
  return (
...
function BackgroundImage3({ text, text1 }: BackgroundImage3Props) {
  return (
    <div className="col-1 h-[41px] ml-[6px] mt-[16px] relative row-1 w-[114px]">
      <BackgroundImageAndText8 text={text} additionalClassNames="left-[3px] top-[26px] w-[83px]" />
      <div className="absolute content-stretch flex h-[12px] items-center left-0 top-[26px] w-[106px]">
...
function ActivityBackgroundImage({ text, text1, additionalClassNames = "" }: ActivityBackgroundImageProps) {
  return (
    <BackgroundImage5>
      <ModuloDeAtividadesButtonSymbolBackgroundImageAndText text="􀆊" additionalClassNames="rounded-[500px]" />
      <ModuloDeAtividadesButtonSymbolBackgroundImageAndText text="􀓔" additionalClassNames="bg-[#dde3ec] rounded-[8px]" />
...
function BackgroundImage1({ additionalClassNames = "" }: BackgroundImage1Props) {
  return (
    <div className="content-stretch flex gap-[10px] items-center relative shrink-0">
      <BackgroundImageAndText5 text="􀆊" additionalClassNames="shrink-0" />
      <BackgroundImage text="+55 98899-8899" text1="04/07/2023 09:30" />
      <div className="bg-[rgba(255,255,255,0)] h-[20px] shrink-0 w-[52px]" />
      <ButtonSymbolBackgroundImageAndText text="􀍀" additionalClassNames="rounded-[500px] size-[28px]" />
    </div>
  );
}
...
type ModuloDeAtividadesBackgroundImage2Props = {
  text: string;
  text1: string;
  additionalClassNames?: string;
};

function ModuloDeAtividadesBackgroundImage2({ text, text1, additionalClassNames = "" }: ModuloDeAtividadesBackgroundImage2Props) {
  return (
...
function BackgroundImageAndText5({ text, additionalClassNames = "" }: BackgroundImageAndText5Props) {
  return <BackgroundImageAndText6 text={text} additionalClassNames={clsx("flex flex-col font-['SF_Pro:Semibold',sans-serif] font-[590] justify-center leading-[0] relative size-[13px] text-[#4e6987] text-[12px] text-center", additionalClassNames)} />;
}
...
function BackgroundImageAndText4({ text, additionalClassNames = "" }: BackgroundImageAndText4Props) {
  return <BackgroundImageAndText6 text={text} additionalClassNames={clsx("-translate-x-1/2 -translate-y-1/2 absolute flex flex-col font-['SF_Pro:Semibold',sans-serif] font-[590] justify-center leading-[0] left-1/2 size-[28px] text-[17px] text-center top-1/2", additionalClassNames)} />;
}
...
function ModuloDeAtividadesButtonSymbolBackgroundImageAndText({ text, additionalClassNames = "" }: ModuloDeAtividadesButtonSymbolBackgroundImageAndTextProps) {
  return (
    <div className={clsx("overflow-clip relative shrink-0 size-[28px]", additionalClassNames)}>
      <BackgroundImageAndText4 text={text} additionalClassNames="text-[#4e6987]" />
    </div>
  );
}
...
function ModuloDeAtividadesBackgroundImageAndText1({ text }: ModuloDeAtividadesBackgroundImageAndText1Props) {
  return (
    <div style={{ fontVariationSettings: "'wdth' 100" }} className="flex flex-col font-['SF_Pro:Semibold',sans-serif] font-[590] justify-center leading-[0] overflow-hidden relative shrink-0 text-[#545454] text-[15px] text-center text-ellipsis whitespace-nowrap">
      <p className="leading-[20px] overflow-hidden">{text}</p>
    </div>
  );
}
...
function ButtonSymbolBackgroundImage({ additionalClassNames = "" }: ButtonSymbolBackgroundImageProps) {
  return (
    <div style={{ backgroundImage: "url('data:image/svg+xml;utf8,<svg viewBox=\\'0 0 28 28\\' xmlns=\\'http://www.w3.org/2000/svg\\' preserveAspectRatio=\\'none\\'><rect x=\\'0\\' y=\\'0\\' height=\\'100%\\' width=\\'100%\\' fill=\\'url(%23grad)\\' opacity=\\'0.20000000298023224\\'/><defs><radialGradient id=\\'grad\\' gradientUnits=\\'userSpaceOnUse\\' cx=\\'0\\' cy=\\'0\\' r=\\'10\\' gradientTransform=\\'matrix(-6.3973e-9 -2.2 2.2 -6.3973e-9 14 28)\\'><stop stop-color=\\'rgba(255,255,255,1)\\' offset=\\'0\\'/><stop stop-color=\\'rgba(255,255,255,0)\\' offset=\\'1\\'/></radialGradient></defs></svg>'), linear-gradient(90deg, rgb(7, 171, 222) 0%, rgb(7, 171, 222) 100%)" }} className="absolute left-[210px] overflow-clip rounded-[500px] size-[28px] top-[20px]">
      <BackgroundImageAndText3 text="􀊫" additionalClassNames="text-[#f6f7f9]" />
    </div>
  );
}
...
function BackgroundImageAndText2({ text }: BackgroundImageAndText2Props) {
  return (
    <div style={{ fontVariationSettings: "'wdth' 100" }} className="-translate-x-1/2 -translate-y-1/2 absolute flex flex-col font-['SF_Pro:Medium',sans-serif] font-[510] justify-center leading-[0] left-1/2 size-[50px] text-[#28415c] text-[24px] text-center top-1/2">
      <p className="leading-[22px] whitespace-pre-wrap">{text}</p>
    </div>
  );
}
...
function BackgroundImageAndText1({ text, additionalClassNames = "" }: BackgroundImageAndText1Props) {
  return (
    <div className={clsx("col-1 ml-[13.5px] overflow-clip relative rounded-[500px] row-1 size-[28px]", additionalClassNames)}>
      <BackgroundImageAndText3 text={text} additionalClassNames="text-[#28415c]" />
    </div>
  );
}
        ...
        <div className={isPesquisa ? "absolute inset-0 pointer-events-none rounded-[inherit] shadow-[inset_0px_-0.5px_1px_0px_rgba(255,255,255,0.3),inset_0px_-0.5px_1px_0px_rgba(255,255,255,0.25),inset_0px_1.5px_4px_0px_rgba(0,0,0,0.08),inset_0px_1.5px_4px_0px_rgba(0,0,0,0.1)]" : "content-stretch flex gap-[20px] items-center p-[20px] relative size-full"}>
          {(isDefault3 || isDefault1 || isDefault2 || isHover || isDefault) && (
            <>
                ...
                {(isDefault3 || isDefault1 || isDefault2 || isHover) && (
                  <>
                    <div className={`overflow-clip relative rounded-[8px] shrink-0 size-[28px] ${isDefault2 ? "bg-[#d9f8ef]" : isDefault1 ? "bg-[#dcf0ff]" : "bg-[#dde3ec]"}`} data-name="Button - Symbol">
                      <div className={`-translate-x-1/2 -translate-y-1/2 absolute flex flex-col font-["SF_Pro:Semibold",sans-serif] font-[590] justify-center leading-[0] left-1/2 size-[28px] text-center top-1/2 ${isDefault1 || isDefault2 || isHover ? "text-[#28415c] text-[13px]" : "text-[#4e6987] text-[17px]"}`} style={isDefault1 || isDefault2 || isHover ? { fontVariationSettings: "'wdth' 100" } : { fontVariationSettings: "'wdth' 100", fontFeatureSettings: "'ss15'" }}>
              ...
              <div className="overflow-clip relative rounded-[500px] shrink-0 size-[28px]" data-name="Button - Symbol">
                <div className={`-translate-x-1/2 -translate-y-1/2 absolute flex flex-col font-["SF_Pro:Semibold",sans-serif] font-[590] justify-center leading-[0] left-1/2 size-[28px] text-[#28415c] text-center top-1/2 ${isDefault1 || isDefault2 || isHover || isDefault ? "text-[13px]" : "text-[17px]"}`} style={isDefault1 || isDefault2 || isHover || isDefault ? { fontVariationSettings: "'wdth' 100" } : { fontVariationSettings: "'wdth' 100", fontFeatureSettings: "'ss15'" }}>
          ...
          {(isDefault3 || isDefault1 || isDefault2 || isHover) && (
            <div className="overflow-clip relative rounded-[500px] shrink-0 size-[28px]" data-name="Button - Symbol">
              <div className={`-translate-x-1/2 -translate-y-1/2 absolute flex flex-col font-["SF_Pro:Semibold",sans-serif] font-[590] justify-center leading-[0] left-1/2 size-[28px] text-[#28415c] text-center top-1/2 ${isDefault1 || isDefault2 || isHover ? "text-[13px]" : "text-[17px]"}`} style={isDefault1 || isDefault2 || isHover ? { fontVariationSettings: "'wdth' 100" } : { fontVariationSettings: "'wdth' 100", fontFeatureSettings: "'ss15'" }}>
...
function ModuloDeAtividades({ className, property1 = "Default" }: ModuloDeAtividadesProps) {
  ...
  const isVariant8OrVariant4OrVariant5 = ["Variant8", "Variant4", "Variant5"].includes(property1);
  ...
  return (
    <div className={className || "h-[652px] relative w-[306px]"}>
        ...
        <>
          <div className="absolute inset-[0.31%_0_89.26%_0]">
            <div className={isVariant6 ? "absolute bg-[#dde3ec] h-[28px] left-[20px] rounded-[100px] top-[20px] w-[218px]" : isVariant4OrVariant5 ? "flex flex-row items-center size-full" : "flex flex-row items-center justify-end size-full"}>
              <div className={isVariant6 ? "absolute inset-0 pointer-events-none rounded-[inherit] shadow-[inset_0px_-0.5px_1px_0px_rgba(255,255,255,0.3),inset_0px_-0.5px_1px_0px_rgba(255,255,255,0.25),inset_0px_1.5px_4px_0px_rgba(0,0,0,0.08),inset_0px_1.5px_4px_0px_rgba(0,0,0,0.1)]" : isVariant4OrVariant5 ? "content-stretch flex gap-[20px] items-center p-[20px] relative size-full" : "content-stretch flex gap-[20px] items-center justify-end p-[20px] relative size-full"}>
                {isVariant8OrVariant4OrVariant5 && (
                  <>
                    <div className="content-stretch flex items-center p-[6px] relative rounded-[8px] shrink-0 w-[170px]">
                      <div className={`overflow-clip relative rounded-[8px] shrink-0 size-[28px] ${isVariant4OrVariant5 ? "bg-[#dcf0ff]" : "bg-[#d9f8ef]"}`} data-name="Button - Symbol">
                        <BackgroundImage11>{isVariant4OrVariant5 ? "􀌤" : isVariant8 ? "􀌾" : ""}</BackgroundImage11>
                      </div>
                      <div className="h-[20px] shrink-0 w-[6px]" />
                      <p className="font-['DM_Sans:Medium',sans-serif] leading-[22px] not-italic relative shrink-0 text-[#4e6987] text-[18px] tracking-[-0.5px]" style={{ fontFeatureSettings: "'ss01', 'ss04', 'ss05', 'ss07'" }}>
                        {isVariant4OrVariant5 ? "Mensagens" : isVariant8 ? "Ligações" : ""}
                      </p>
          ...
          <div className={`absolute ${isVariant5 ? "contents inset-[26.99%_6.54%_1.84%_6.54%]" : isVariant4OrVariant6 ? "contents inset-[10.74%_6.21%_18.1%_6.86%]" : "content-stretch flex inset-[2.15%_37.91%_91.72%_6.54%] items-center p-[6px] rounded-[8px]"}`}>
            ...
            <div className={`overflow-clip size-[28px] ${isVariant5 ? "absolute bg-[#f6f7f9] left-[243px] rounded-[500px] top-[526px]" : isVariant4OrVariant6 ? "absolute bg-[#f6f7f9] left-[244px] rounded-[500px] top-[420px]" : "bg-[#d9f8ef] relative rounded-[8px] shrink-0"}`} data-name="Button - Symbol">
              <BackgroundImage11>{isVariant4OrVariant6OrVariant5 ? "􀈄" : isVariant8 ? "􀇸" : ""}</BackgroundImage11>
            </div>
            {isVariant8 && (
              <>
                <div className="h-[20px] shrink-0 w-[6px]" />
      ...
      {["Variant7", "Variant2"].includes(property1) && (
        <div className={`absolute bg-[#f6f7f9] rounded-[100px] ${isVariant2 ? "inset-[2.15%_4.9%_91.1%_4.9%]" : "-translate-x-1/2 bottom-[91.1%] left-[calc(50%+9px)] top-[2.15%]"}`} data-name="Segmented Control">
          <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
            <div className={`content-stretch flex gap-[4px] items-center justify-center p-[4px] relative ${isVariant2 ? "size-full" : "h-full"}`}>
              <div className={`backdrop-blur-[50px] bg-[#28415c] h-[36px] relative rounded-[20px] ${isVariant2 ? "flex-[1_0_0] min-h-px min-w-px" : "shrink-0"}`} data-name="Button 1">
                <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
                  <div className={`content-stretch flex gap-[3px] items-center justify-center relative ${isVariant2 ? "px-[8px] size-full" : "h-full px-[16px]"}`}>
                    <div className={`flex flex-col justify-center leading-[0] overflow-hidden relative shrink-0 text-center text-ellipsis whitespace-nowrap ${isVariant2 ? 'font-["DM_Sans:Bold",sans-serif] not-italic text-[#f6f7f9] text-[10px] tracking-[0.5px] uppercase' : 'font-["SF_Pro:Semibold",sans-serif] font-[590] text-[15px] text-[rgba(255,255,255,0.96)]'}`} style={isVariant2 ? { fontFeatureSettings: "'ss01', 'ss04', 'ss05', 'ss07'" } : { fontVariationSettings: "'wdth' 100" }}>
              ...
              <div className={`h-[36px] relative rounded-[100px] ${isVariant2 ? "flex-[1_0_0] min-h-px min-w-px" : "shrink-0"}`} data-name="Button 2">
                <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
                  <div className={`content-stretch flex gap-[3px] items-center justify-center relative ${isVariant2 ? "px-[8px] size-full" : "h-full px-[16px]"}`}>
                    <ModuloDeAtividadesBackgroundImageAndText1 text="Label" />
                  </div>
                </div>
              </div>
              {isVariant7 && (
        ...
        <>
          <div className="absolute content-stretch flex flex-col gap-[4px] inset-[19.33%_0.49%_12.27%_0.49%] items-center" data-name="Atividades">
            ...
            <BackgroundImage5>
              ...
              <div className="bg-[#ffedeb] overflow-clip relative rounded-[8px] shrink-0 size-[28px]" data-name="Button - Symbol">
                <BackgroundImageAndText4 text="􀉉" additionalClassNames="text-[#ff8c76]" />
              </div>
              <p className="font-['DM_Sans:Medium',sans-serif] leading-[22px] not-italic relative shrink-0 text-[#4e6987] text-[15px] tracking-[-0.5px] w-[110px] whitespace-pre-wrap" style={{ fontFeatureSettings: "'ss01', 'ss04', 'ss05', 'ss07'" }}>
                Compromisso
              </p>
            ...
            <BackgroundImage5>
              ...
              <div className="bg-[#e8e8fd] overflow-clip relative rounded-[8px] shrink-0 size-[28px]" data-name="Button - Symbol">
                <BackgroundImageAndText4 text="􀁢" additionalClassNames="text-[#8c8cd4]" />
              </div>
              <p className="font-['DM_Sans:Medium',sans-serif] leading-[22px] not-italic relative shrink-0 text-[#4e6987] text-[15px] tracking-[-0.5px] w-[110px] whitespace-pre-wrap" style={{ fontFeatureSettings: "'ss01', 'ss04', 'ss05', 'ss07'" }}>
                Tarefa
              </p>
            ...
            <BackgroundImage5>
              ...
              <div className="bg-[#d9f8ef] overflow-clip relative rounded-[8px] shrink-0 size-[28px]" data-name="Button - Symbol">
                <BackgroundImageAndText4 text="􀌾" additionalClassNames="text-[#3ccea7]" />
              </div>
              <p className="font-['DM_Sans:Medium',sans-serif] leading-[22px] not-italic relative shrink-0 text-[#4e6987] text-[15px] tracking-[-0.5px] w-[110px] whitespace-pre-wrap" style={{ fontFeatureSettings: "'ss01', 'ss04', 'ss05', 'ss07'" }}>
                Ligação
              </p>
            ...
            <BackgroundImage5>
              ...
              <div className="bg-[#feedca] overflow-clip relative rounded-[8px] shrink-0 size-[28px]" data-name="Button - Symbol">
                <BackgroundImageAndText4 text="􀻡" additionalClassNames="text-[#eac23d]" />
              </div>
              <p className="font-['DM_Sans:Medium',sans-serif] leading-[22px] not-italic relative shrink-0 text-[#4e6987] text-[15px] tracking-[-0.5px] w-[110px] whitespace-pre-wrap" style={{ fontFeatureSettings: "'ss01', 'ss04', 'ss05', 'ss07'" }}>
                Nota
              </p>
            ...
            <BackgroundImage5>
              ...
              <div className="bg-[#dcf0ff] overflow-clip relative rounded-[8px] shrink-0 size-[28px]" data-name="Button - Symbol">
                <BackgroundImageAndText4 text="􀌤" additionalClassNames="text-[#07abde]" />
              </div>
              <p className="font-['DM_Sans:Medium',sans-serif] leading-[22px] not-italic relative shrink-0 text-[#4e6987] text-[15px] tracking-[-0.5px] w-[110px] whitespace-pre-wrap" style={{ fontFeatureSettings: "'ss01', 'ss04', 'ss05', 'ss07'" }}>
                Mensagem
              </p>
            ...
            <BackgroundImage5>
              <ModuloDeAtividadesButtonSymbolBackgroundImageAndText text="􀆊" additionalClassNames="rounded-[500px]" />
              <ModuloDeAtividadesButtonSymbolBackgroundImageAndText text="􀍕" additionalClassNames="bg-[#dde3ec] rounded-[8px]" />
              <p className="font-['DM_Sans:Medium',sans-serif] leading-[22px] not-italic relative shrink-0 text-[#4e6987] text-[15px] tracking-[-0.5px] w-[110px] whitespace-pre-wrap" style={{ fontFeatureSettings: "'ss01', 'ss04', 'ss05', 'ss07'" }}>
                Email
              </p>
              <p className="font-['DM_Sans:Bold',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#4e6987] text-[10px] text-right tracking-[0.5px] uppercase w-[102px] whitespace-pre-wrap" style={{ fontFeatureSettings: "'ss01', 'ss04', 'ss05', 'ss07'" }}>
          ...
          <SegmentedControlBackgroundImage>
            <ButtonBackgroundImage>
              <ModuloDeAtividadesBackgroundImage2 text="􀺿" text1="feed" additionalClassNames="text-[#f6f7f9]" />
            </ButtonBackgroundImage>
            <button className="cursor-pointer flex-[1_0_0] h-[36px] min-h-px min-w-px relative rounded-[100px]" data-name="Button 2">
              ...
              <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
                <ModuloDeAtividadesBackgroundImage2 text="􁃪" text1="engajamento" additionalClassNames="text-[#98989d]" />
              </div>
            </button>
          </SegmentedControlBackgroundImage>
        </>
          ...
          <BackgroundImage6>
            <div className="content-stretch flex items-center p-[6px] relative rounded-[8px] shrink-0 w-[170px]">
              <div className={`overflow-clip relative rounded-[8px] shrink-0 size-[28px] ${isVariant7 ? "bg-[#d9f8ef]" : "bg-[#dde3ec]"}`} data-name="Button - Symbol">
                <div className={`-translate-x-1/2 -translate-y-1/2 absolute flex flex-col font-["SF_Pro:Semibold",sans-serif] font-[590] justify-center leading-[0] left-1/2 size-[28px] text-center top-1/2 ${isVariant7 ? "text-[#28415c] text-[13px]" : "text-[#4e6987] text-[17px]"}`} style={isVariant7 ? { fontVariationSettings: "'wdth' 100" } : { fontVariationSettings: "'wdth' 100", fontFeatureSettings: "'ss15'" }}>
            ...
            {isDefault && (
              <button className="block cursor-pointer overflow-clip relative rounded-[500px] shrink-0 size-[28px]" data-name="Button - Symbol">
                <BackgroundImageAndText4 text="􀜓" additionalClassNames="text-[#28415c]" />
              </button>
            )}
            <div className="overflow-clip relative rounded-[500px] shrink-0 size-[28px]" data-name="Button - Symbol">
              <div className={`-translate-x-1/2 -translate-y-1/2 absolute flex flex-col font-["SF_Pro:Semibold",sans-serif] font-[590] justify-center leading-[0] left-1/2 size-[28px] text-[#28415c] text-center top-1/2 ${isVariant7 ? "text-[13px]" : "text-[17px]"}`} style={isVariant7 ? { fontVariationSettings: "'wdth' 100" } : { fontVariationSettings: "'wdth' 100", fontFeatureSettings: "'ss15'" }}>
                <p className="leading-[22px] whitespace-pre-wrap">{isVariant7 ? "􀊫" : "􀆏"}</p>
              </div>
            </div>
            {isVariant7 && <ButtonSymbolBackgroundImageAndText text="􀜓" additionalClassNames="rounded-[500px] size-[28px]" />}
          </BackgroundImage6>
          <BackgroundImage7>
            <div className={`content-stretch flex gap-[4px] items-center justify-center leading-[0] px-[12px] relative size-full text-[#28415c] text-center whitespace-nowrap ${isVariant7 ? "text-[15px]" : ""}`}>
              <div className={`flex flex-col font-["SF_Pro:Semibold",sans-serif] font-[590] justify-center relative shrink-0 ${isVariant7 ? "" : "text-[16px]"}`} style={{ fontVariationSettings: "'wdth' 100" }}>
                <p className={isVariant7 ? "leading-[20px]" : "leading-[22px]"}>{isVariant7 ? "􀍀" : "􀅼"}</p>
              </div>
              <div className={`flex flex-col justify-center relative shrink-0 tracking-[-0.5px] ${isVariant7 ? 'font-["DM_Sans:SemiBold",sans-serif] font-semibold' : 'font-["DM_Sans:Medium",sans-serif] not-italic text-[15px]'}`} style={isVariant7 ? { fontVariationSettings: "'opsz' 14", fontFeatureSettings: "'ss01', 'ss04', 'ss05', 'ss07'" } : { fontFeatureSettings: "'ss01', 'ss04', 'ss05', 'ss07'" }}>
                <p className="leading-[22px]">{isVariant7 ? "Label" : "Adicionar atividade"}</p>
              </div>
            </div>
          </BackgroundImage7>
        </>
        ...
        <div className="-translate-x-1/2 absolute bottom-[10.25%] content-stretch flex flex-col gap-[20px] items-center left-[calc(50%+1.5px)] top-[19.33%]">
          <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0">
            <div className="col-1 content-stretch flex gap-[10px] items-center ml-0 mt-0 relative row-1">
              <div className="flex items-center justify-center relative shrink-0 size-[13px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "19" } as React.CSSProperties}>
                <div className="flex-none rotate-90">
                  <BackgroundImageAndText5 text="􀆊" />
                </div>
              </div>
              <BackgroundImage text="+55 98899-8899" text1="04/07/2023 09:30" />
            ...
            <div className="col-1 grid-cols-[max-content] grid-rows-[max-content] inline-grid ml-[41px] mt-[42.99px] place-items-start relative row-1">
              ...
              <div className="col-1 ml-[18px] mt-[28.01px] overflow-clip relative row-1 size-[18px]" data-name="timer 1">
                <div className="absolute contents inset-0" data-name="Camada 1">
                  <ModuloDeAtividadesBackgroundImage1 />
                  <div className="absolute inset-[15.06%_15.03%_15.03%_15.03%]" data-name="Regular-S">
                    <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 78.85 78.82">
                      <g id="Regular-S">
                        <path d={svgPaths.p38bcb970} fill="var(--fill-0, #F6F7F9)" id="Vector" />
                      </g>
                    </svg>
                  </div>
                </div>
              </div>
              <BackgroundImageAndText1 text="􀌄" additionalClassNames="mt-[58.01px]" />
              <BackgroundImageAndText1 text="􀍀" additionalClassNames="mt-[23.01px]" />
            </div>
          </div>
          <BackgroundImage1 />
          <BackgroundImage1 />
      ...
      {isVariant8 && (
        <>
          <div className="absolute bg-[#f6f7f9] inset-[34.97%_64.05%_57.06%_18.95%] overflow-clip rounded-[500px]" data-name="Button - Symbol">
            <BackgroundImageAndText2 text="1" />
          </div>
          <div className="absolute bg-[#f6f7f9] inset-[46.01%_64.05%_46.01%_18.95%] overflow-clip rounded-[500px]" data-name="Button - Symbol">
            <BackgroundImageAndText2 text="4" />
          </div>
          <div className="absolute bg-[#f6f7f9] inset-[57.06%_64.05%_34.97%_18.95%] overflow-clip rounded-[500px]" data-name="Button - Symbol">
            <BackgroundImageAndText2 text="7" />
          </div>
          <div className="absolute bg-[#f6f7f9] inset-[68.1%_64.05%_23.93%_18.95%] overflow-clip rounded-[500px]" data-name="Button - Symbol">
            <BackgroundImageAndText2 text="*" />
          </div>
          <div className="absolute bg-[#f6f7f9] inset-[34.97%_41.83%_57.06%_41.18%] overflow-clip rounded-[500px]" data-name="Button - Symbol">
            <BackgroundImageAndText2 text="2" />
          </div>
          <div className="absolute bg-[#f6f7f9] inset-[46.01%_41.83%_46.01%_41.18%] overflow-clip rounded-[500px]" data-name="Button - Symbol">
            <BackgroundImageAndText2 text="5" />
          </div>
          <div className="absolute bg-[#f6f7f9] inset-[57.06%_41.83%_34.97%_41.18%] overflow-clip rounded-[500px]" data-name="Button - Symbol">
            <BackgroundImageAndText2 text="8" />
          </div>
          <div className="absolute bg-[#f6f7f9] inset-[68.1%_41.83%_23.93%_41.18%] overflow-clip rounded-[500px]" data-name="Button - Symbol">
            <BackgroundImageAndText2 text="0" />
          </div>
          <div className="absolute backdrop-blur-[50px] bg-[#3ccea7] inset-[79.14%_41.83%_12.88%_41.18%] rounded-[500px]" data-name="Button - Symbol">
            <div className="overflow-clip relative rounded-[inherit] size-full">
              <BackgroundImageAndText2 text="􀌿" />
            </div>
          ...
          <div className="absolute bg-[#f6f7f9] inset-[34.97%_19.61%_57.06%_63.4%] overflow-clip rounded-[500px]" data-name="Button - Symbol">
            <BackgroundImageAndText2 text="3" />
          </div>
          <div className="absolute bg-[#f6f7f9] inset-[46.01%_19.61%_46.01%_63.4%] overflow-clip rounded-[500px]" data-name="Button - Symbol">
            <BackgroundImageAndText2 text="6" />
          </div>
          <div className="absolute bg-[#f6f7f9] inset-[57.06%_19.61%_34.97%_63.4%] overflow-clip rounded-[500px]" data-name="Button - Symbol">
            <BackgroundImageAndText2 text="9" />
          </div>
          <div className="absolute bg-[#f6f7f9] inset-[68.1%_19.61%_23.93%_63.4%] overflow-clip rounded-[500px]" data-name="Button - Symbol">
            <BackgroundImageAndText2 text="#" />
          </div>
      ...
      {isVariant5 && (
        <>
          ...
          <div className="absolute bg-[#dcf0ff] h-[32px] left-[163px] rounded-[100px] top-[118px] w-[123px]" data-name="Drop Down Button">
            <BackgroundImage2 text="APLICAR" text1="􀆈" />
          </div>
        </>
      )}
      {isVariant3 && (
        <>
          <div className="absolute contents inset-[0.31%_0_0_0]" data-name="Mask group">
            <div className="absolute content-stretch flex flex-col gap-[4px] inset-[31.6%_0.49%_0_0.49%] items-center mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-1.5px_-204px] mask-size-[306px_650px]" data-name="Atividades" style={{ maskImage: `url('${imgAtividades}')` }}>
              ...
              <ActivityBackgroundImage text="Atividade" text1="04/01/2024 09:30" />
              <p className="font-['DM_Sans:Bold',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#64676c] text-[10px] text-center tracking-[0.5px] uppercase w-[102px] whitespace-pre-wrap" style={{ fontFeatureSettings: "'ss01', 'ss04', 'ss05', 'ss07'" }}>
                Julho
              </p>
              <ActivityBackgroundImage text="Atividade" text1="04/01/2024 09:30" />
          ...
          <SegmentedControlBackgroundImage>
            ...
            <BackgroundImage8 additionalClassNames="flex-[1_0_0] min-h-px min-w-px">
              <div className="content-stretch flex gap-[3px] items-center justify-center px-[8px] relative size-full">
                <ModuloDeAtividadesBackgroundImageAndText1 text="Label" />
              </div>
            </BackgroundImage8>
          ...
          <BackgroundImage6>
            <div className="content-stretch flex items-center p-[6px] relative rounded-[8px] shrink-0 w-[170px]">
              <ModuloDeAtividadesButtonSymbolBackgroundImageAndText text="􀣔" additionalClassNames="bg-[#dde3ec] rounded-[8px]" />
              <div className="h-[20px] shrink-0 w-[6px]" />
              <p className="font-['DM_Sans:Medium',sans-serif] leading-[22px] not-italic relative shrink-0 text-[#4e6987] text-[18px] tracking-[-0.5px]" style={{ fontFeatureSettings: "'ss01', 'ss04', 'ss05', 'ss07'" }}>
                Atividades
              </p>
              <ModuloDeAtividadesButtonSymbolBackgroundImageAndText text="􀆈" additionalClassNames="rounded-[500px]" />
            </div>
            <div className="overflow-clip relative rounded-[500px] shrink-0 size-[28px]" data-name="Button - Symbol">
              <BackgroundImageAndText4 text="􀜓" additionalClassNames="text-[#28415c]" />
            </div>
            <div className="overflow-clip relative rounded-[500px] shrink-0 size-[28px]" data-name="Button - Symbol">
              <BackgroundImageAndText4 text="􀆏" additionalClassNames="text-[#28415c]" />
            </div>
          </BackgroundImage6>
          <ModuloDeAtividadesButtonTextBackgroundImage text="􀅼" text1="Label" />
      ...
      {isVariant2 && (
        <>
          ...
          <div className="absolute content-stretch flex flex-col gap-[26px] inset-[19.33%_52.29%_13.19%_6.54%] items-center leading-[0]">
            <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0">
              <div className="bg-[#f6f7f9] col-1 h-[45px] ml-0 mt-[14px] rounded-[8px] row-1 w-[126px]" />
              <BackgroundImage3 text="Há 20 dias" text1="Abaixo da média" />
              <div className="col-1 content-stretch flex h-[10px] items-center ml-0 mt-0 relative row-1 w-[126px]">
                ...
                <BackgroundImageAndText7 text="ÚLTIMA ATIVIDADE" />
              </div>
            </div>
            <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0">
              <div className="bg-[#f6f7f9] col-1 h-[45px] ml-0 mt-[14px] rounded-[8px] row-1 w-[126px]" />
              <BackgroundImage3 text="5 Emails" text1="Abaixo da média" />
              <div className="col-1 content-stretch flex h-[10px] items-center ml-0 mt-0 relative row-1 w-[126px]">
                <ButtonSymbolBackgroundImageAndText text="􀆿" additionalClassNames="rounded-[100px] size-[16px]" />
                <BackgroundImageAndText7 text="emails trocados" />
              </div>
            </div>
            <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0">
              <div className="bg-[#f6f7f9] col-1 h-[45px] ml-0 mt-[14px] rounded-[8px] row-1 w-[126px]" />
              <div className="col-1 h-[29px] ml-[6px] mt-[22px] relative row-1 w-[114px]">
                <BackgroundImageAndText8 text="56% WhatsApp" additionalClassNames="left-[4px] top-[26px] w-[106px]" />
              </div>
              <div className="col-1 content-stretch flex h-[10px] items-center ml-0 mt-0 relative row-1 w-[126px]">
                <ButtonSymbolBackgroundImageAndText text="􀆿" additionalClassNames="rounded-[100px] size-[16px]" />
                <BackgroundImageAndText7 text="canal principal" />
              </div>
            </div>
            <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0">
              <div className="bg-[#f6f7f9] col-1 h-[45px] ml-0 mt-[14px] rounded-[8px] row-1 w-[126px]" />
              <div className="col-1 h-[41px] ml-[6px] mt-[16px] relative row-1 w-[114px]">
                <BackgroundImageAndText8 text="7,3 pontos" additionalClassNames="left-[3px] top-[25px] w-[111px]" />
                <BackgroundImage4 />
              </div>
              <div className="col-1 content-stretch flex h-[10px] items-center ml-0 mt-0 relative row-1 w-[126px]">
                <ButtonSymbolBackgroundImageAndText text="􀆿" additionalClassNames="rounded-[100px] size-[16px]" />
                <BackgroundImageAndText7 text="renitência" />
              </div>
            </div>
            <BackgroundImage12>
              <ButtonSymbolBackgroundImageAndText text="􀆿" additionalClassNames="rounded-[100px] size-[16px]" />
              <BackgroundImageAndText7 text="TAREFA FUTURA?" />
            </BackgroundImage12>
          </div>
          <div className="absolute content-stretch flex flex-col gap-[26px] inset-[19.33%_6.54%_13.19%_52.29%] items-center leading-[0]">
            <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0">
              <div className="bg-[#f6f7f9] col-1 h-[45px] ml-0 mt-[14px] rounded-[8px] row-1 w-[126px]" />
              <div className="col-1 h-[41px] ml-[6px] mt-[16px] relative row-1 w-[114px]">
                <BackgroundImageAndText8 text="31 atividades" additionalClassNames="left-[3px] top-[25px] w-[111px]" />
                <div className="absolute content-stretch flex h-[12px] items-center left-0 top-[26px] w-[106px]">
              ...
              <div className="col-1 content-stretch flex h-[10px] items-center ml-0 mt-0 relative row-1 w-[126px]">
                <ButtonSymbolBackgroundImageAndText text="􀆿" additionalClassNames="rounded-[100px] size-[16px]" />
                <BackgroundImageAndText7 text="ATIVIDADES TOTAIS" />
              </div>
            </div>
            <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0">
              <div className="bg-[#f6f7f9] col-1 h-[45px] ml-0 mt-[14px] rounded-[8px] row-1 w-[126px]" />
              <div className="col-1 h-[41px] ml-[6px] mt-[16px] relative row-1 w-[114px]">
                <BackgroundImageAndText8 text="7 ligações" additionalClassNames="left-[3px] top-[25px] w-[111px]" />
                <BackgroundImage4 />
              </div>
              <div className="col-1 content-stretch flex h-[10px] items-center ml-0 mt-0 relative row-1 w-[126px]">
                <ButtonSymbolBackgroundImageAndText text="􀆿" additionalClassNames="rounded-[100px] size-[16px]" />
                <BackgroundImageAndText7 text="total de ligações" />
              </div>
            </div>
            <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0">
              <div className="bg-[#f6f7f9] col-1 h-[45px] ml-0 mt-[14px] rounded-[8px] row-1 w-[126px]" />
              <BackgroundImage3 text="1h e 56 m" text1="Abaixo da média" />
              <div className="col-1 content-stretch flex h-[10px] items-center ml-0 mt-0 relative row-1 w-[126px]">
                <ButtonSymbolBackgroundImageAndText text="􀆿" additionalClassNames="rounded-[100px] size-[16px]" />
                <BackgroundImageAndText7 text="tempo de resposta" />
              </div>
            </div>
            <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0">
              <div className="bg-[#f6f7f9] col-1 h-[45px] ml-0 mt-[14px] rounded-[8px] row-1 w-[126px]" />
              ...
              <div className="col-1 content-stretch flex h-[10px] items-center ml-0 mt-0 relative row-1 w-[126px]">
                <ButtonSymbolBackgroundImageAndText text="􀆿" additionalClassNames="rounded-[100px] size-[16px]" />
                <BackgroundImageAndText7 text="total de reuniões" />
              </div>
            </div>
            <BackgroundImage12>
              <ButtonSymbolBackgroundImageAndText text="􀆿" additionalClassNames="rounded-[100px] size-[16px]" />
              <BackgroundImageAndText7 text="tem anotações" />
            </BackgroundImage12>
          </div>
          <ModuloDeAtividadesButtonTextBackgroundImage text="􀅼" text1="Label" />
        </>
...
export default function ModuloDeAtividades1() {
  return <ModuloDeAtividades className="relative size-full" />;
}