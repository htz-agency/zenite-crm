export default function ButtonText() {
  return (
    <button className="backdrop-blur-[50px] content-stretch cursor-pointer flex items-start relative shadow-[0px_2px_4px_0px_rgba(18,34,50,0.3)] size-full" data-name="Button - Text">
      <div className="bg-[#bcdaf1] content-stretch flex gap-[3px] h-[40px] items-center justify-center leading-[0] overflow-clip pl-[16px] pr-[20px] relative rounded-[100px] shrink-0 text-[#28415c] text-center whitespace-nowrap" data-name="Button - Text">
