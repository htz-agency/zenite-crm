...
import svgPaths from "./svg-gbsl779g8n";
...
import { imgAtividades } from "./svg-8ulf4";
  ...
  return (
    <div className={clsx("h-[36px] relative rounded-[100px]", additionalClassNames)}>
      <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className={clsx("content-stretch flex gap-[3px] items-center justify-center relative", additionalClassNames)}>
          <ModuloDeAtividadesBackgroundImageAndText2 text="Label" additionalClassNames="text-[#545454]" />
        </div>
      </div>
    </div>
  );
    ...
    <div className="absolute bg-[#dcf0ff] inset-[91.87%_21.24%_3.22%_21.24%] rounded-[500px]">
      <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[4px] items-center justify-center leading-[0] px-[12px] relative size-full text-[#28415c] text-[15px] text-center whitespace-nowrap">
          ...
          <div style={{ fontVariationSettings: "'opsz' 14", fontFeatureSettings: "'ss01', 'ss04', 'ss05', 'ss07'" }} className="flex flex-col font-['DM_Sans:SemiBold',sans-serif] font-semibold justify-center relative shrink-0 tracking-[-0.5px]">
...
type ButtonTextBackgroundImageAndTextProps = {
  text: string;
};

function ButtonTextBackgroundImageAndText({ text }: ButtonTextBackgroundImageAndTextProps) {
  ...
  return (
    <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
      <div className="content-stretch flex items-center justify-center pl-[18px] pr-[17px] relative size-full">
        <BackgroundImage8>{text}</BackgroundImage8>
        <HighlightFrameBackgroundImage />
        <BackgroundImage9>{text1}</BackgroundImage9>
      </div>
    </div>
  );
}
...
function BackgroundImage1({ additionalClassNames = "" }: BackgroundImage1Props) {
  return (
    <div className="content-stretch flex gap-[10px] items-center relative shrink-0">
      <ModuloDeAtividadesBackgroundImageAndText text="􀆊" additionalClassNames="shrink-0" />
...
type SegmentedControlBackgroundImageProps = {
  additionalClassNames?: string;
};

function SegmentedControlBackgroundImage({ additionalClassNames = "" }: SegmentedControlBackgroundImageProps) {
  return (
    <div className="absolute bg-[#f6f7f9] inset-[2.15%_4.9%_91.1%_4.9%] rounded-[100px]">
      <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[4px] items-center justify-center p-[4px] relative size-full">
          <div className="backdrop-blur-[50px] bg-[#28415c] flex-[1_0_0] h-[36px] min-h-px min-w-px relative rounded-[20px]" data-name="Button 1">
            <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
              <div className="content-stretch flex gap-[3px] items-center justify-center px-[8px] relative size-full">
                <ModuloDeAtividadesBackgroundImageAndText2 text="Label" additionalClassNames="text-[rgba(255,255,255,0.96)]" />
              </div>
            </div>
          ...
          <BackgroundImage7 additionalClassNames="flex-[1_0_0] min-h-px min-w-px" additionalClassNames1="px-[8px] size-full" />
        </div>
      </div>
    ...
    <div className="relative rounded-[8px] shrink-0 w-[303px]">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[4px] items-center px-[12px] py-[6px] relative w-full">
          <ButtonSymbolBackgroundImageAndText text="􀆊" additionalClassNames="rounded-[500px] size-[28px]" />
          <ButtonSymbolBackgroundImageAndText text="􀓔" additionalClassNames="bg-[#dde3ec] rounded-[8px] size-[28px]" />
...
type ModuloDeAtividadesBackgroundImageAndText2Props = {
  text: string;
  additionalClassNames?: string;
};

function ModuloDeAtividadesBackgroundImageAndText2({ text, additionalClassNames = "" }: ModuloDeAtividadesBackgroundImageAndText2Props) {
  return (
    <div style={{ fontVariationSettings: "'wdth' 100" }} className={clsx("flex flex-col font-['SF_Pro:Semibold',sans-serif] font-[590] justify-center leading-[0] overflow-hidden relative shrink-0 text-[15px] text-center text-ellipsis whitespace-nowrap", additionalClassNames)}>
...
function ModuloDeAtividadesBackgroundImageAndText({ text, additionalClassNames = "" }: ModuloDeAtividadesBackgroundImageAndTextProps) {
  return (
    <div style={{ fontVariationSettings: "'wdth' 100", fontFeatureSettings: "'ss15'" }} className={clsx("flex flex-col font-['SF_Pro:Semibold',sans-serif] font-[590] justify-center leading-[0] relative size-[13px] text-[#4e6987] text-[12px] text-center", additionalClassNames)}>
      <p className="leading-[22px] whitespace-pre-wrap">{text}</p>
    </div>
  );
}
        ...
        <div className={isPesquisa ? "absolute inset-0 pointer-events-none rounded-[inherit] shadow-[inset_0px_-0.5px_1px_0px_rgba(255,255,255,0.3),inset_0px_-0.5px_1px_0px_rgba(255,255,255,0.25),inset_0px_1.5px_4px_0px_rgba(0,0,0,0.08),inset_0px_1.5px_4px_0px_rgba(0,0,0,0.1)]" : "content-stretch flex gap-[20px] items-center p-[20px] relative size-full"}>
          {(isDefault3 || isDefault1 || isDefault2 || isHover || isDefault) && (
            <>
              <div className={`content-stretch flex items-center p-[6px] relative rounded-[8px] shrink-0 ${isDefault ? "w-[218px]" : isHover ? "bg-[#f6f7f9] w-[170px]" : "w-[170px]"}`}>
                ...
                {(isDefault3 || isDefault1 || isDefault2 || isHover) && (
                  <div className="overflow-clip relative rounded-[500px] shrink-0 size-[28px]" data-name="Button - Symbol">
                    <div className={`-translate-x-1/2 -translate-y-1/2 absolute flex flex-col font-["SF_Pro:Semibold",sans-serif] font-[590] justify-center leading-[0] left-1/2 size-[28px] text-center top-1/2 ${isDefault2 ? "text-[#4e6987] text-[17px]" : "text-[#28415c] text-[13px]"}`} style={isDefault2 ? { fontVariationSettings: "'wdth' 100", fontFeatureSettings: "'ss15'" } : { fontVariationSettings: "'wdth' 100" }}>
              ...
              <div className="overflow-clip relative rounded-[500px] shrink-0 size-[28px]" data-name="Button - Symbol">
                <div className={`-translate-x-1/2 -translate-y-1/2 absolute flex flex-col font-["SF_Pro:Semibold",sans-serif] font-[590] justify-center leading-[0] left-1/2 size-[28px] text-[#28415c] text-center top-1/2 ${isDefault2 ? "text-[17px]" : "text-[13px]"}`} style={isDefault2 ? { fontVariationSettings: "'wdth' 100", fontFeatureSettings: "'ss15'" } : { fontVariationSettings: "'wdth' 100" }}>
    ...
    <div className={className || `h-[32px] relative rounded-[100px] ${state === "Idle (No Platter)" ? "" : isHover ? "bg-[#f6f7f9]" : state === "Selected" ? "bg-[#dcf0ff] shadow-[0px_3px_5px_0px_rgba(0,0,0,0.12)]" : "bg-[#dde3ec]"}`}>
      <div className="flex flex-row items-center justify-center size-full">
        <div className={`content-stretch flex h-full items-center justify-center overflow-clip pl-[18px] pr-[17px] relative ${isHover ? "" : ["Selected", "Idle (No Platter)"].includes(state) ? "gap-[5px] leading-[0] text-[#28415c] text-center whitespace-nowrap" : "gap-[5px] leading-[0] text-[#98989d] text-center whitespace-nowrap"}`}>
          ...
          {isHover && (
            <>
              <BackgroundImage8>{label}</BackgroundImage8>
              <HighlightFrameBackgroundImage />
              <BackgroundImage9>􀆈</BackgroundImage9>
            </>
          )}
        </div>
      </div>
    ...
    <div className={className || "h-[652px] relative w-[306px]"}>
                ...
                {isVariant8 && (
                  <>
                    <button className="block cursor-pointer overflow-clip relative rounded-[500px] shrink-0 size-[28px]" data-name="Button - Symbol">
                      <BackgroundImageAndText3 text="􀄘" />
                    </button>
                    <div className="overflow-clip relative rounded-[500px] shrink-0 size-[28px]" data-name="Button - Symbol">
                      <BackgroundImageAndText3 text="􀆄" />
                    </div>
                  </>
                )}
              </div>
        ...
        <div className={`absolute bg-[#f6f7f9] rounded-[100px] ${isVariant2 ? "inset-[2.15%_4.9%_91.1%_4.9%]" : "-translate-x-1/2 bottom-[91.1%] left-[calc(50%-1px)] top-[2.15%]"}`} data-name="Segmented Control">
          <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
            <div className={`content-stretch flex gap-[4px] items-center justify-center p-[4px] relative ${isVariant2 ? "size-full" : "h-full"}`}>
              ...
              {isVariant7 && <BackgroundImage7 additionalClassNames="shrink-0" additionalClassNames1="h-full px-[16px]" />}
            </div>
          </div>
          <div className="absolute inset-0 pointer-events-none rounded-[inherit] shadow-[inset_0px_-0.5px_1px_0px_rgba(255,255,255,0.3),inset_0px_-0.5px_1px_0px_rgba(255,255,255,0.25),inset_1px_1.5px_4px_0px_rgba(0,0,0,0.08),inset_1px_1.5px_4px_0px_rgba(0,0,0,0.1)]" />
        </div>
          ...
          <BackgroundImage6>
            <div className="content-stretch flex items-center p-[6px] relative rounded-[8px] shrink-0 w-[170px]">
              <div className={`overflow-clip relative rounded-[8px] shrink-0 size-[28px] ${isVariant7 ? "bg-[#d9f8ef]" : "bg-[#dde3ec]"}`} data-name="Button - Symbol">
                <div className={`-translate-x-1/2 -translate-y-1/2 absolute flex flex-col font-["SF_Pro:Semibold",sans-serif] font-[590] justify-center leading-[0] left-1/2 size-[28px] text-center top-1/2 ${isVariant7 ? "text-[#3ccea7] text-[17px]" : "text-[#28415c] text-[13px]"}`} style={isVariant7 ? { fontVariationSettings: "'wdth' 100", fontFeatureSettings: "'ss15'" } : { fontVariationSettings: "'wdth' 100" }}>
              ...
              <div className="overflow-clip relative rounded-[500px] shrink-0 size-[28px]" data-name="Button - Symbol">
                <div className={`-translate-x-1/2 -translate-y-1/2 absolute flex flex-col font-["SF_Pro:Semibold",sans-serif] font-[590] justify-center leading-[0] left-1/2 size-[28px] text-center top-1/2 ${isVariant7 ? "text-[#4e6987] text-[17px]" : "text-[#28415c] text-[13px]"}`} style={isVariant7 ? { fontVariationSettings: "'wdth' 100", fontFeatureSettings: "'ss15'" } : { fontVariationSettings: "'wdth' 100" }}>
                  <p className="leading-[22px] whitespace-pre-wrap">􀆈</p>
                </div>
              </div>
            </div>
            <div className="overflow-clip relative rounded-[500px] shrink-0 size-[28px]" data-name="Button - Symbol">
              <div className={`-translate-x-1/2 -translate-y-1/2 absolute flex flex-col font-["SF_Pro:Semibold",sans-serif] font-[590] justify-center leading-[0] left-1/2 size-[28px] text-[#28415c] text-center top-1/2 ${isVariant7 ? "text-[17px]" : "text-[13px]"}`} style={isVariant7 ? { fontVariationSettings: "'wdth' 100", fontFeatureSettings: "'ss15'" } : { fontVariationSettings: "'wdth' 100" }}>
                <p className="leading-[22px] whitespace-pre-wrap">{isVariant7 ? "􀊫" : "􀜓"}</p>
              </div>
            </div>
            <div className="overflow-clip relative rounded-[500px] shrink-0 size-[28px]" data-name="Button - Symbol">
              <div className={`-translate-x-1/2 -translate-y-1/2 absolute flex flex-col font-["SF_Pro:Semibold",sans-serif] font-[590] justify-center leading-[0] left-1/2 size-[28px] text-[#28415c] text-center top-1/2 ${isVariant7 ? "text-[17px]" : "text-[13px]"}`} style={isVariant7 ? { fontVariationSettings: "'wdth' 100", fontFeatureSettings: "'ss15'" } : { fontVariationSettings: "'wdth' 100" }}>
                <p className="leading-[22px] whitespace-pre-wrap">{isVariant7 ? "􀜓" : "􀆏"}</p>
              </div>
            </div>
          </BackgroundImage6>
          <BackgroundImage5>{isVariant7 ? "􀍀" : "􀅼"}</BackgroundImage5>
        </>
      )}
      {isVariant7 && (
            ...
            <div className="col-1 content-stretch flex gap-[10px] items-center ml-0 mt-0 relative row-1">
              <div className="flex items-center justify-center relative shrink-0 size-[13px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "19" } as React.CSSProperties}>
                <div className="flex-none rotate-90">
                  <ModuloDeAtividadesBackgroundImageAndText text="􀆊" />
                </div>
              </div>
              <BackgroundImage text="+55 98899-8899" text1="04/07/2023 09:30" />
      ...
      {isVariant3 && (
        <>
          ...
          <BackgroundImage6>
            <div className="content-stretch flex items-center p-[6px] relative rounded-[8px] shrink-0 w-[170px]">
              <ButtonSymbolBackgroundImageAndText text="􀣔" additionalClassNames="bg-[#dde3ec] rounded-[8px] size-[28px]" />
              <div className="h-[20px] shrink-0 w-[6px]" />
              <p className="font-['DM_Sans:Medium',sans-serif] leading-[22px] not-italic relative shrink-0 text-[#4e6987] text-[18px] tracking-[-0.5px]" style={{ fontFeatureSettings: "'ss01', 'ss04', 'ss05', 'ss07'" }}>
                Atividades
              </p>
            ...
            <ButtonSymbolBackgroundImageAndText text="􀜓" additionalClassNames="rounded-[500px] size-[28px]" />
            <ButtonSymbolBackgroundImageAndText text="􀆏" additionalClassNames="rounded-[500px] size-[28px]" />
          </BackgroundImage6>
          <ButtonTextBackgroundImageAndText text="􀅼" />
