 ...
 * Shows a loading spinner while checking, redirects to /login if not.
 */
    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-[#122232]">
      ...
      >
        ...
        <motion.div
          ...
          className="flex items-center justify-center size-[48px] rounded-[14px] bg-[#28415c]"
        >
          <svg width="24" height="24" viewBox="0 0 28 28" fill="none">
            <path
              d="M4 8L14 4L24 8V20L14 24L4 20V8Z"
              stroke="#07ABDE"
              strokeWidth="2"
...
export function RequireAuth() {
  ...
  // In preview mode, always render children (bypass auth)
  if (IS_PREVIEW) {
    return <Outlet />;
  }
