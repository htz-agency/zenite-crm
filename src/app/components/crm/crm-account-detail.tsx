...
type AccountTab = "detalhes" | "contatos" | "oportunidades" | "propostas" | "contrato" | "relacionado";
              ...
              <div className="p-[18px]">
                ...
                {activeTab === "detalhes" && (
                  <div className="mb-[24px]">
                    <StageBar stages={STAGES} current={stage} onChange={handleStageChange} layoutId="account-pipeline-active" />
                  </div>
                )}
                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    ...
                    {activeTab === "propostas" && <CrmLinkedProposals accountId={account.id} />}
